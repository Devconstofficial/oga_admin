...
class _MyCustomTextFieldState extends State<MyCustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: AppStyles.poppinsTextStyle().copyWith(color: widget.textColor,fontSize: 14),
      decoration: InputDecoration(
        ...
        suffixIcon: widget.suffixIcon != null
          ...
          icon: Icon(widget.suffixIcon,color: widget.suffixIconColor ?? kDarkGrey,size: 18,),
        )
            : null,
